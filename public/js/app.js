...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onFileChange: function onFileChange(event) {
      ...
      // 何も選択されていなかったら処理中断
      if (event.target.fiiles.length === 0) {
        this.reset();
        return false;
      } // ファイルが画像ではなかったら処理中断
    ...
    reset: function reset() {
      this.preview = '';
      this.$el.querySelecter('input[type="file"]').value = null;
    }
  }
});
            ...
            _vm.loginErrors
              ? _c("div", { staticClass: "errors" }, [
                  _vm.loginErrors.email
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.msg in _vm.loginErrors.password
                    ? _c(
                        "ul",
...
module.exports = __webpack_require__(/*! /home/vagrant/code/Laravel/resources/js/app.js */"./resources/js/app.js");
